...
*/
        ...
        try {
            PathFinder pf = new PathFinder(start, end);
            Stopwatch aStar = new Stopwatch();
            pf.dijkstra(randomlyGenMatrix);
            StdOut.println("Elapsed time  Dijkstra's Search= " + aStar.elapsedTime());
            ...
            System.out.println("Count "+end.getMoveCost());
